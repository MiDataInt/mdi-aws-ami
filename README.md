...
---
---
## Additional server instance setup

### Mount an AWS Elastic File System (EFS)
...
Next, launch and populate a Tier 3 or Tier 4 MDI server using our AMIs as described above.
